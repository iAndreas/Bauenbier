   ...
   ?>
    ...
    <div id="clonedForm" class="cadastroGato" style="margin-top: 10px;">
      ...
      <div class="input-field">
        ...
        <input type="number" name="volume_em_litros" id="volume_em_litros" step=".01" value="<?php echo $volume_em_litros; ?>"  data-constraints="@Required">
      </div>
      <div class="input-field">
        <label for="dencidade_mosto_pre_fervura">OG (Densidade Original)</label>
        <input type="number" name="dencidade_mosto_pre_fervura" id="dencidade_mosto_pre_fervura" step = "any" min="0.0000" max="2.9999" value="<?php echo $dencidade_mosto_pre_fervura; ?>"  data-constraints="@Required">
      </div>
      <div class="input-field">
        <label for="tempo_fervura">Tempo de Fervura (Min)</label>
        <input type="number" name="tempo_fervura" id="tempo_fervura" value="<?php echo $tempo_fervura; ?>"  data-constraints="@Required">
     </div>
      <div class="input-field">
        <label for="peso_lupulo_g">Massa do Lúpulo (g)</label>
        <input type="number" step=".001" name="peso_lupulo_g" id="peso_lupulo_g" value="<?php echo $peso_lupulo_g; ?>"  data-constraints="@Required">
      </div>
      <div class="input-field">
        <label for="alfa_acido">Alfa Ácido (%)</label>
        <input type="number" step=".01" name="alfa_acido" id="alfa_acido" value="<?php echo $alfa_acido; ?>"  data-constraints="@Required">
      </div>
      <br>
