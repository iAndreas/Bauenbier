    ...
    <title>TCC</title>
        ...
        <body class="blue-grey lighten-5">
          ...
          <div class="container white" style="width: 100%; border-radius: 0px 0px 10px 10px; box-shadow: 0px 8px 15px lightgrey;">
            ...
            ?>
        <br/><br/><br/>
        <form method="get" action="inserir_lupulos.php" id="form">

          <input type="hidden" name="n1" value="<?php echo $codigoUsuario ?>">
          <input type="hidden" name="n2" value="<?php echo $IBU_total ?>">

          <button class="btn waves-effect waves-light amber darken-3" type="submit" name="acao" value="salvar">Salvar
            <i class="material-icons right">send</i>
          </button>
